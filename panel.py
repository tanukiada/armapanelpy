...
class App:
    ...
    def RunApp(self):
        ...
        ttk.Button(frm, text="Start Server", command=lambda: App.StartServer(combobox, combobox2)).grid(column=0, row=3)
        ttk.Button(frm, text="Stop Server", command=App.StopServer).grid(column=1, row=3)
        ...
        ttk.Label(frm, text="Server Profile: ").grid(column=0, row = 2)
